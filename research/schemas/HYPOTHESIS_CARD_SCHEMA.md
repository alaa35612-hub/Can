...
adaptive_context: {symbol_history: null, timeframe: null, liquidity: null, volatility: null, regime: null}
adversarial_review:
...
A pattern name is never sufficient. The card must explain ordered facts better than alternatives with fewer unsupported assumptions.
