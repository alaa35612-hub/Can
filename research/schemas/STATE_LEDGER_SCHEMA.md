...
source_files: []
data_range: {first_closed_candle: null, last_closed_candle: null}
quality: {status: HIGH | MEDIUM | LOW | UNUSABLE, flags: [], confidence_cap: null}
campaign:
  birth_time: null
...
milestones:
  ...
  rebuild: null
hypotheses:
  dominant: {name: null, status: RESEARCH_HYPOTHESIS}
  alternatives: []
  failure_or_noise: null
  unidentified_structure_considered: true
evidence: {supporting: [], opposing: [], missing: []}
trajectories: {price: null, oi: null, oi_value: null, execution: null, positioning: null, acceptance: null}
assessment:
...
transitions:
  - timestamp: null
    ...
    cutoff_frozen: true
outcome: {visibility: HIDDEN | REVEALED, classification: null, revealed_after_frozen_record: true}
```

Rules: record `NOT_OBSERVED_IN_CURRENT_SAMPLE` as observation, not failure; one opposing candle cannot reverse a campaign; every transition needs timestamped evidence; outcome remains hidden during blind replay.
